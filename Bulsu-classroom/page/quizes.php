...
<header class="w3-container" style="padding-top:5px;">
    <h5><i class="fas fa-file-alt fa-fw w3-text-blue"></i>&nbsp;Quiz List</h5>
</header>
<div class="w3-row-padding">
    <div class="w3-col m3">
      <div class="w3-container w3-blue w3-padding-16">
        ...
        <h4>Quizes<br><span class="w3-small">Total of Quiz Distribute</span></h4>
      </div>
    </div>
    <div class="w3-col m9">
    <button type="button" onclick="document.getElementById('quiz-form').style.display='block'" class="w3-btn w3-margin-bottom w3-border w3-round">
...
<!---------------ADD FORM MODAL------------------>
<div id="quiz-form" class="w3-modal">
<div class="w3-modal-content w3-animate-top w3-card-4" style="width:750px;">
    ...
    <span id="closed_href"><span onclick="document.getElementById('quiz-form').style.display='none'" 
    class="w3-button w3-display-topright w3-medium fa fa-times"></span></span>
    <h4><i class="fa fa-plus fa-fw"></i> New Quiz</h4>
    </header>
    <form class="w3-row-padding" id="quiz-form-add">
        <input type="hidden" name="action_type" value="add_quiz" readonly>
        ...
        <footer class="w3-container w3-padding w3-center" id="submit_an_add">
            <button type="button" onclick="exam_add();" class="w3-btn w3-border w3-green w3-round-xxlarge">
            Submit
            </button>
        </footer>
    </div>
...
<?php }else{ ?>
<header class="w3-container" style="padding-top:5px;">
    <h5><i class="far fa-bell fa-fw w3-text-red"></i> Exam</h5>
</header>
