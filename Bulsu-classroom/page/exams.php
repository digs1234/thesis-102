...
<header class="w3-container" style="padding-top:5px;">
    <h5><i class="fas fa-file-alt fa-fw w3-text-teal"></i>&nbsp;Exam List</h5>
</header>
<div class="w3-row-padding">
    ...
    <div class="w3-col m9">
    <button type="button" onclick="document.getElementById('exam-form').style.display='block'" class="w3-btn w3-margin-bottom w3-border w3-round">
    <i class="fa fa-plus fa-fw"></i> New Exam
    </button>
...
<!---------------ADD FORM MODAL------------------>
<div id="exam-form" class="w3-modal">
<div class="w3-modal-content w3-animate-top w3-card-4" style="width:750px;">
    ...
    <span id="closed_href"><span onclick="document.getElementById('exam-form').style.display='none'" 
    class="w3-button w3-display-topright w3-medium fa fa-times"></span></span>
    <h4><i class="fa fa-plus fa-fw"></i> New exam</h4>
    </header>
    <form class="w3-row-padding" id="exam-form-add">
        <input type="hidden" name="action_type" value="add_exam" readonly>
